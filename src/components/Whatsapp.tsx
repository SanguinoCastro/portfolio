    ...
    <>
      <div className='buttons__text flex flex-col gap-[2rem] justify-center items-center'>
        <button
          ...
          className='whatsapp__button olive w-[25.3rem] h-[5rem] rounded-xl text-[1.8rem] transition-all duration-300 flex gap-[1rem] justify-center items-center hover:scale-105 px-[2rem]'
        >
          <Image
            src={whatsappImg}
            alt='whatsapp'
