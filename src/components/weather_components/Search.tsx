  ...
  return (
    <div className='w-full h-full border-rad flex flex-col items-center justify-center'>
      <div className='w-full flex justify-center z-10'>
        <div className='flex w-full  justify-end pr-[0.5rem]'>
          <input
            className='border border-r-0 border-[var(--olive)] w-[40%] mr-[-7%] rounded-l text-center pr-[2.5rem] h-[2.5rem] text-[1.4rem]  opacity-60'
          ...
          <button
            onClick={handleClick}
            className=' bg-[var(--olive)] w-[2.5rem] h-[2.3rem] mt-[0.1rem]'
          >
            <SearchIcon />
          </button>
        </div>
